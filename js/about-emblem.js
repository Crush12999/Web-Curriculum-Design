...
Emblem.prototype.drawFu = function (ctx, ox, oy, x1, y1, x2, y2, counterclockwise) {
...
Emblem.prototype.drawBg = function (ctx) {
    const n = this.n;
...
Emblem.prototype.drawHammer = function (ctx) {
    const n = this.n;
    const x = this.x - this.n * 16;
    const y = this.y - this.n * 16;
...
Emblem.prototype.drawSickle = function (ctx) {
    const n = this.n;
    const x = this.x - this.n * 16;
    const y = this.y - this.n * 16;
    const drawFu = this.drawFu;
...
//静态画国徽
Emblem.prototype.draw = function (ctx) {
    //画国徽start
    this.drawBg(ctx);
    this.drawHammer(ctx);
    this.drawSickle(ctx);
...
//动态画国徽
Emblem.prototype.dynDraw = function (ctx) {
    const n = this.n;
    const x = this.x - this.n * 16;
    const y = this.y - this.n * 16;
    const drawFu = this.drawFu;
